                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <div class="rounded-circle border border-secondary bg-dark d-flex align-items-center justify-content-center overflow-hidden" style="width: 40px; height: 40px;">
                                    @if($testimonial->image)
                                        <img src="{{ $testimonial->image }}" alt="Client" class="w-100 h-100 object-fit-cover">
                                    @else
