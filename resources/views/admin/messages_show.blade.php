...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold fs-4 m-0 text-white">Message <span class="text-red italic">Details</span></h2>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="admin-table-card p-5">
                <div class="d-flex justify-content-between align-items-start mb-4 border-bottom border-secondary pb-4">
                    <div>
                        <h4 class="text-white fw-bold mb-1">{{ $message->subject }}</h4>
                        <p class="text-muted small m-0">From: <span class="text-white">{{ $message->name }}</span> &lt;{{ $message->email }}&gt;</p>
                    </div>
                    <div class="text-end">
                ...
                <div class="message-content text-white mb-5" style="white-space: pre-wrap; line-height: 1.6;">{{ $message->message }}</div>
